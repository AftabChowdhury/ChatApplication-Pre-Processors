		    ...
		    public void windowClosing(java.awt.event.WindowEvent windowEvent) {
		    	...
		    	if(chatClient != null){
			    	try {
			    		...
			    		/*if[Exchange1st2Letters]*/
			    		message = exchange2Letter("Bye all, I am leaving");
			    		/*end[Exchange1st2Letters]*/
			    		sendMessage(message);		        				        	
	...
	public ClientRMIGUI(){
		...
		while(true){
		  try {
    		...
    		/*if[Exchange1st2Letters]*/
			message = exchange2Letter(message);
    		/*end[Exchange1st2Letters]*/
		    ...
		    try {  
		        ...
		        /*if[Exchange1st2Letters]*/
		        messageToLog = exchange2Letter(message);
		        /*end[Exchange1st2Letters]*/
